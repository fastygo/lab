...
// GroupProps configures Group.
type GroupProps struct {
	// Class — adds Tailwind utilities
	Class string
	// Tag — div, fieldset, or dl. Use fieldset for related form controls.
	Tag   string
	Attrs templ.Attributes
}

// GroupClasses composes Group classes without rendering —
...
// Group renders the Group contract.
func Group(p GroupProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		switch uiutils.ResolveTag(p.Tag, "div", uiutils.TagGroupGroup) {
		case "fieldset":
			var templ_7745c5c3_Var2 = []any{GroupClasses(p)}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/group/group.templ`, Line: 1, Col: 0}
			}
		...
		case "dl":
			var templ_7745c5c3_Var4 = []any{GroupClasses(p)}
		...
		default:
			var templ_7745c5c3_Var6 = []any{GroupClasses(p)}
